...
export function BingoModal({ onDismiss }: BingoModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4">
      <div className="relative w-full max-w-sm min-w-[280px] overflow-hidden rounded-4xl border border-white/60 bg-white/95 p-6 text-center shadow-[0_30px_80px_-40px_rgba(124,58,237,0.45)] animate-[bounce_0.5s_ease-out]">
        ...
        <button
          onClick={onDismiss}
          className="mt-8 inline-flex w-full items-center justify-center rounded-full bg-linear-to-r from-fuchsia-500 via-pink-500 to-violet-500 px-5 py-3 text-sm font-semibold text-white shadow-[0_16px_50px_-20px_rgba(236,72,153,0.65)] transition hover:scale-[1.01] active:translate-y-0.5 focus-visible:ring-2 focus-visible:ring-violet-300 focus-visible:ring-offset-2"
        >
          Seguir jugando
        </button>
      </div>
